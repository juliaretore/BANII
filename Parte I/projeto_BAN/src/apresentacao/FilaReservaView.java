...
public class FilaReservaView extends JFrame {
	...
	public FilaReservaView() {
		...
		scrollPane.setBounds(48, 157, 999, 433);
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Usu\u00E1rio", "ISBN", "T\u00EDtulo", "Data de reserva"
			}
		));
		...
		textPCodigo.addCaretListener(new CaretListener() {
			public void caretUpdate(CaretEvent e) {			
				...
				else filtro.setRowFilter(RowFilter.regexFilter(textPCodigo.getText(), 2));  
			}
		});
		...
		lblid.setBounds(331, 41, 52, 20);
		contentPane.add(lblid);
		
		JLabel lblUsurio = new JLabel("ISBN:");
		lblUsurio.setForeground(new Color(85, 97, 120));
		lblUsurio.setFont(new Font("Lato Black", Font.BOLD, 15));
		lblUsurio.setBounds(341, 63, 146, 20);
		contentPane.add(lblUsurio);
		
		JLabel lblBusca_1_1 = new JLabel("FILA RESERVA");
	...
	public static void atualizarTabela() {
		try {
			historico = sistema.listarFilaReserva();
			DefaultTableModel model = (DefaultTableModel) table.getModel();
			model.setNumRows(0);
